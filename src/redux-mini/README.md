...
3.2 测试实现的 redux，仍然是用计数器作为例子(该例子如有雷同纯属必然😜)

3.2.1 创建 store/index.js
...
3.2.2 创建 ReduxPage.js 组件，并在 index.js 中引入该组件
...
3.2.3 如图浏览器中显示的结果，连续派发多次 action 后，视图对应变更，
